...
export class GrowersComponent implements OnInit {
	...
	apiCalling() {
		...
		// this.gs.getGrowerBySupervisorId()
		// 	.subscribe(data => {
		// 		this.growerTable = data['data'];
		// 		console.log(this.growerTable);
		// 	}, (error) => {
