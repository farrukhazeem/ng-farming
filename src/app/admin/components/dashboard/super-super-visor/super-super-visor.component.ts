...
declare let $;
@Component({
  selector: 'app-super-super-visor',
  templateUrl: './super-super-visor.component.html',
  styleUrls: ['./super-super-visor.component.css']
})
export class SuperSuperVisorComponent implements OnInit {
